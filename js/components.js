...
(function () {
    ...
    '        </defs>',
    '      </svg>',
    '      <span class="nav-title">3DEXPERIENCE AI 开放平台</span>',
    '    </div>',
    '    <div class="nav-links">',
    ...
    '            </defs>',
    '          </svg>',
    '          <span>3DEXPERIENCE / V5 AI开放平台</span>',
    '        </div>',
    '      </div>',
    ...
    '      <span>&copy; 2026 3DEXPERIENCE / V5 AI开放平台. CATIA is a registered trademark of Dassault Systèmes.</span>',
