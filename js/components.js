...
(function () {
    ...
    '        </defs>',
    '      </svg>',
    '      <span class="nav-title">3DEXPERIENCE &amp; AI</span>',
    '    </div>',
    '    <div class="nav-links">',
    ...
    '    </div>',
    '    <button class="btn-nav-cta">控制台</button>',
    ...
    '          </defs>',
    '        </svg>',
    '        <span class="nav-title">3DEXPERIENCE MCP</span>',
    '      </a>',
    '    </div>',
    '    <div class="nav-links">',
    ...
    '      <span>&copy; 2026 3DEXPERIENCE / V5 MCP. CATIA is a registered trademark of Dassault Systèmes.</span>',
